...
进入用户家目录，使用如下命令设置凭据：
```shell
liecho@DESKTOP-4J249B2 MINGW64 ~
...
liecho@DESKTOP-4J249B2 MINGW64 ~/.ssh
$ ls
id_rsa  id_rsa.pub
...
```shell
liecho@DESKTOP-4J249B2 MINGW64 /d/othergitrepository/gh-project-ChoAh/gh-project (master)
